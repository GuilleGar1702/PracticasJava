 ...
 * @author Guillermo
 */
public class Palindromo extends javax.swing.JPanel {

    /**
     * Creates new form Palindromo
     */
    private Interfaz inter;
    public Palindromo(Interfaz inter) {
        initComponents();
        this.inter = inter;
    }
    ...
    private void initComponents() {
        ...
        LblTitulo1.setText("Introduzca el palíndromo a revisar");
    ...
    //Ejercicio 8
    public void palindromo(String cadena, int p, String palindromo){
        if (p<cadena.length()){
            ...
            if (cadena.equals(palindromo)){
                TFSalida.setText("Palíndromo");
            }
            else{
                TFSalida.setText("Palíndromon't");
            }
        }
    }
    ...
    private void TFEntradaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFEntradaKeyPressed
        if (evt.getKeyCode()== KeyEvent.VK_ENTER){
            palindromo(TFEntrada.getText(), 0, "");
        }
