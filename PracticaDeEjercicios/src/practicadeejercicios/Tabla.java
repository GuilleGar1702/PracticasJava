...
public class Tabla extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        LblTitulo1.setText("Introduzca el elemento a multiplicar");
    ...
    //Ejercicio 5
    public void tabla(int x, int n){
        if (n<12){
            TAMovimientos.append(x + " x " + (n+1) + " = " + (x*(n+1))+"\n");
            tabla(x, n+1);
        }
    }
    ...
    private void TFEntradaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFEntradaKeyPressed
        if (evt.getKeyCode()== KeyEvent.VK_ENTER){
            tabla(Integer.parseInt(TFEntrada.getText()), 0);
        }
